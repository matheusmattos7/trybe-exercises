...
firstDiv.addEventListener('click', changeClassTag);
secondDiv.addEventListener('click', changeClassTag);
thirdDiv.addEventListener('click', changeClassTag);
...
myWebpage.addEventListener('dblclick', function() {
  window.location.replace('https://matheusmattos7.github.io/')
});
